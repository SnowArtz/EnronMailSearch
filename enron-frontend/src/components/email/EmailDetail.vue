<template>
    <aside class="w-[65%] bg-white p-6 shadow-xl rounded-xl mx-2 my-2">
        <div v-if="email"
            ...
            <div class="flex justify-between items-start mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        <h2 class="text-2xl font-bold line-clamp-2 max-w-full" v-html="highlightedSubject"></h2>
                ...
                <button 
                    ...
                    class="p-2 hover:bg-gray-100 inline-flex flex-none w-auto items-center justify-center rounded-full transition-colors"
                    title="Cerrar correo"
                >
        ...
        <div v-else class="flex flex-col items-center justify-center h-full">
            <svg class="w-24 h-24 text-gray-500 mb-2" fill="none" stroke="currentColor" stroke-width="1"
                viewBox="0 0 24 24">
                <path
